...
from Run_Processing import run_processing, run_post_processing
...
def run_tgdp(input_data, game_number_string, start_game_year, save_images_boolean):
    ...
    for commands_data in input_data:
        ...
        #commands, processed_commands, nodes, units = run_processing(commands, commanders, nodes, units)
        commands = run_processing(commands, commanders, nodes, units)
        processed_commands, commanders, nodes, units = run_post_processing(commands, commanders, nodes, units)
        """
